        ...
        <div class="inner">
            ...
            <div class="list_other">
                <ul>
                    ...
                    <li>
                        <a href="<?php echo esc_url(home_url('/program/tabi/'))?>">旅・グルメ番組</a>
                    </li>
                    <li>
                        <a href="<?php echo esc_url(home_url('/program/variety/')) ?>">バラエティ番組</a>
                    </li>
                    <li>
                        ...
                        <?php while (have_rows('home_social_banners', 'option')) :
                            ...
                            <li>
                                <a href="<?php echo $social_banner_url ?>">
                                    <img src="<?php echo $social_banner_img ?>" width="420" height="105"
                                         alt="social_banner_img">
                                </a>
                            </li>
                        <?php endwhile; ?>
                    </ul>
        ...
        <div class="inner">
            ...
            <div class="list_other">
                <ul>
                    ...
                    <li>
                        <a href="<?php echo esc_url(home_url('/program/music/'))?>">音楽番組</a>
                    </li>
                </ul>
            </div>
            <!--   Social banners     -->
