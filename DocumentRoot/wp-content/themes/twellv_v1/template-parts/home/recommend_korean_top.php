...
$args = [
    ...
    // 'hide_empty' => false,
    'parent' => $program_cat_base_items['korea'], // 韓国ドラマのterm_id
    'meta_query' => [
        'relation' =>'AND',
        [
            'key' => 'onair',
...
if ( ! empty( $term_query ) && ! is_wp_error( $term_query ) ) :
    ...
    <section class="section" id="korean_drama">
        <div class="inner">
            ...
            <div class="program_slide slide_korean is_loading">
            ...
            <?php get_template_part('template-parts/home/modal_category', null, array('title'=> '韓国・韓流ドラマ','modal' => $modal)); ?>
        </div>
    </section>
    <?php
endif;